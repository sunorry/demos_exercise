require(['jquery', 'mockjax'], function($,$moc) {
  $(function() {

    //保证点击物理返回键能返回到上个页面
    function manageHisory(id) {
      var state = {
       title : "",
    ...
    var datePick = $('#date-pick'),
        ...
        calendarBack = $('#calendar-back');

    datePick.click(function() {
      transformxy(calendarDetail, 0);
    });
    calendarBack.click(function() {
      transformxy(calendarDetail, '-100%');
    });
